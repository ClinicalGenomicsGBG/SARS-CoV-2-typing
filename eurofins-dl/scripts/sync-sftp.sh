...
lftp -e 'mirror -vvv / /medstore/results/clinical/SARS-CoV-2-typing/eurofins_data/goteborg; bye' \
  -u $FTPUSER,$FTPKEY \
...
# This section is commented out as it is now being done by a python script
